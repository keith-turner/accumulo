...
public interface TabletScanningServer {
  ...
  TableConfiguration getTableConfiguration(KeyExtent extent);
  ...
  BlockCacheConfiguration getBlockCacheConfiguration(AccumuloConfiguration acuConf);
}
