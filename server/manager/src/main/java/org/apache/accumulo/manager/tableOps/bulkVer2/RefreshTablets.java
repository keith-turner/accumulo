...
public class RefreshTablets extends ManagerRepo {
  ...
  public Repo<Manager> call(long tid, Manager manager) throws Exception {
    ...
    TabletRefresher.refresh(manager.getContext(), tid, bulkInfo.tableId, bulkInfo.firstSplit,
        bulkInfo.lastSplit, tabletMetadata -> tabletMetadata.getLoaded().containsValue(tid));
