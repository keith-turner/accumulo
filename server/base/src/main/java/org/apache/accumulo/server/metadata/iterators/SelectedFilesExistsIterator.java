...
public class SelectedFilesExistsIterator extends WrappingIterator {
  private static final Collection<ByteSequence> FAMS =
      Set.of(new ArrayByteSequence(SelectedColumnFamily.STR_NAME));
  ...
  public void seek(Range range, Collection<ByteSequence> columnFamilies, boolean inclusive)
    ...
    Key startKey = new Key(tabletRow, SelectedColumnFamily.NAME);
    Key endKey = new Key(tabletRow, SelectedColumnFamily.NAME).followingKey(PartialKey.ROW_COLFAM);
