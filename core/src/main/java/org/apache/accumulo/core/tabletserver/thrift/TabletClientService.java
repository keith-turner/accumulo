            ...
            if (field.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                this.loggers = new HashSet<String>(2*_set110.size);
                for (int _i111 = 0; _i111 < _set110.size; ++_i111)
                {
                  String _elem112;
                  _elem112 = iprot.readString();
                  this.loggers.add(_elem112);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.loggers != null) {
        oprot.writeFieldBegin(LOGGERS_FIELD_DESC);
        {
          ...
          for (String _iter113 : this.loggers)
          {
  ...
  public static class getTabletStats_result implements org.apache.thrift.TBase<getTabletStats_result, getTabletStats_result._Fields>, java.io.Serializable, Cloneable   {
            ...
            if (field.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                this.success = new ArrayList<TabletStats>(_list114.size);
                for (int _i115 = 0; _i115 < _list114.size; ++_i115)
                {
                  TabletStats _elem116;
                  _elem116 = new TabletStats();
                  _elem116.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, this.success.size()));
          for (TabletStats _iter117 : this.success)
          {
  ...
  public static class getActiveScans_result implements org.apache.thrift.TBase<getActiveScans_result, getActiveScans_result._Fields>, java.io.Serializable, Cloneable   {
            ...
            if (field.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                this.success = new ArrayList<ActiveScan>(_list118.size);
                for (int _i119 = 0; _i119 < _list118.size; ++_i119)
                {
                  ActiveScan _elem120;
                  _elem120 = new ActiveScan();
                  _elem120.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, this.success.size()));
          for (ActiveScan _iter121 : this.success)
          {
